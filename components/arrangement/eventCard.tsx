    ...
    return (
        <View className={`w-full rounded-lg mb-4 overflow-hidden border-2 border-gray-300`}>
            <Card className="w-full h-fit rounded-lg overflow-hidden">
                ...
                <View className="p-4">
                    <View className="text-lg w-40 h-2 font-bold bg-foreground opacity-25 mb-2 rounded-lg"></View>
                    <View className="flex flex-row items-center justify-between">
                        <View className="w-28 h-2 bg-foreground opacity-25 rounded-lg"></View>
                        <View
                            className={`px-3 rounded-3xl border-2`}
